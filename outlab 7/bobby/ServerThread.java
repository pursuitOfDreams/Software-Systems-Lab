...
public class ServerThread implements Runnable {
	...
	// serverThread is assigned for every pawn playing the game
	...
	public void run() {
		...
		try {
			...
			output = new PrintWriter(this.socket.getOutputStream(), true); // output to client
			input = new BufferedReader(new InputStreamReader(this.socket.getInputStream())); // input from client
			...
			try {
				...
				Thread.currentThread().interrupt(); // thread needs to be interrupted
				this.socket.close();
				return;
			}
			...
			while (true) {
				...
				// System.out.println("Entered round with id " + this.id + " and " +
				...
				// System.out.println("Before barrier 1 with id " + this.id + " and " +
				// this.board.playingThreads);
				...
				// System.out.println("Crossed barrier 1 with id " + this.id + " and " +
				// this.board.playingThreads + " and COUNT " + this.board.count);
				...
				// {
				// this.board.barrier1.acquire();
				// //System.out.println("Playing Threads: " + this.board.playingThreads);
				...
				// System.out.println("Before barrier 2 with id " + this.id + " and " +
				// this.board.playingThreads);
				...
				this.board.barrier2.release();
				// System.out.println("COUNT " + this.board.count);
				...
				// System.out.println("Crossed barrier 2 with id " + this.id + " and " +
				// this.board.playingThreads+ " and COUNT " + this.board.count);
